...
public class Tests {
	...
	public void crypterCaesarAusnahmeKey() throws IllegalKeyException {
		Crypter caesar = new CrypterFactory()
				.createCrypter(CrypterOption.CAESAR);
		Crypter caesar1 = new CrypterFactory().createCrypter("!",
				CrypterOption.CAESAR);
		Crypter caesar2 = new CrypterFactory().createCrypter("ab",
				CrypterOption.CAESAR);
	}
	...
	public void crypterXORAusnahmeKey() throws IllegalKeyException {
		...
		Crypter xor1 = new CrypterFactory().createCrypter("AB! §a",
				CrypterOption.XOR);
		Crypter xor2 = new CrypterFactory().createCrypter("a [] b",
				CrypterOption.XOR);
	}
	...
	public void crypterXORAusnahmeMessage() throws CrypterException {
		Crypter xor = new CrypterFactory().createCrypter("TPERULES",
				CrypterOption.XOR);
		Crypter xor1 = new CrypterFactory().createCrypter("KEY",
				CrypterOption.XOR);
		Crypter xor2 = new CrypterFactory().createCrypter("XOR",
				CrypterOption.XOR);
	...
	public void crypterReverseTest() throws CrypterException {
		...
		assertEquals("ZYXWVUTSRQPONMLKJIHGFEDCBA",
				reverse.encrypt("ABCDEFGHIJKLMNOPQRSTUVWXYZ"));
		assertEquals("ABCDEFGHIJKLMNOPQRSTUVWXYZ",
				reverse.decrypt("ZYXWVUTSRQPONMLKJIHGFEDCBA"));
	...
	public void crypterReverseAusnahmeKey() throws IllegalKeyException {
		...
		Crypter reverse1 = new CrypterFactory().createCrypter("a",
				CrypterOption.REVERSE);
		Crypter reverse2 = new CrypterFactory().createCrypter("%",
				CrypterOption.REVERSE);
	}
